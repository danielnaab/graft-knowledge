...
- **Maintain architecture docs**: Keep [architecture.md](docs/architecture.md) synchronized with decisions
- **Record decisions**: Document tradeoffs in [decisions/](docs/decisions/) using ADR format
...
- Architecture changes? Update [architecture.md](docs/architecture.md) + add decision record
- New tradeoff? Create decision record in [decisions/](docs/decisions/)
